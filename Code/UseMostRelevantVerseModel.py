...
def load_bible_data(ESV_Bible_DF_filepath):
    # Load the Bible dataset from the CSV file or another format
    # Adjust the file path accordingly
    return pd.read_csv(ESV_Bible_DF_filepath)
...
def main():
    ...
    bible_data = load_bible_data(ESV_Bible_DF_filepath)
